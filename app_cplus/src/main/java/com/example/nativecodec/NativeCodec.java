...
public class NativeCodec extends Activity {
    ...
    public void onCreate(Bundle icicle) {
        ...
        String path = Environment.getExternalStorageDirectory() + "/test.yuv";
    ...
    public static native int getDecodeFrameCount();
    public static native int getDecodeFrameCountOK();

    /** Load jni .so on initialization */
    static {
//         System.loadLibrary("hwcodec_ndk");
